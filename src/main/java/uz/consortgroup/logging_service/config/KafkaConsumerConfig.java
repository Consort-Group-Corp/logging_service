package uz.consortgroup.logging_service.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Object> universalConsumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "uz.consortgroup.logging_service.event");

        props.put(JsonDeserializer.USE_TYPE_INFO_HEADERS, true);

        props.put(JsonSerializer.TYPE_MAPPINGS,
                        "user_created:uz.consortgroup.logging_service.event.admin.UserCreatedEvent");
